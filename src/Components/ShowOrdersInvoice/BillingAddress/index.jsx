  ...
  return (
    <div className="mx-lg-4 mt-2">
      ...
      {orderDetails?.order_address === null ? (
        <p className="mb-1">No billing address for this customer</p>
      ) : (
        <>
          <p className="mb-1">{orderDetails?.order_address?.billing_name}</p>
          <p className="mb-1">{orderDetails?.order_address?.billing_email}</p>
          <p className="mb-1">{orderDetails?.order_address?.billing_phone}</p>
          <p className="mb-0">
