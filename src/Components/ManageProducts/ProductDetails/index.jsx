...
export const ProductDetails = () => {
  ...
  const { productGalleryById, createProductGalleryById, deleteProductGalleryById, updateProductGalleryStatus } =
    new productCateoriesAPI();

  const { data, refetch } = useQuery(["product-gallery", id], productGalleryById, {
    enabled: !!id,
  });
